...
IntTol = 0.025;
AreaTol = 0.05;
maxdisp = 200;  %Maximum displacement of cell i.e.radius(in pixels) to search for neighboring focal adhesions
ligase = 3;
...
nlmtch = nearestneighbourDI(nlst1,nlst2,ptch1,ptch2,maxdisp/4,IntTol);
if nlmtch
